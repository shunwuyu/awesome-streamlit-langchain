...
pinecome_api_key = st.text_input("API Key", value=st.session_state["PINECONE_API_KEY"], max_chars=None, key=None, type='default')
...
if  saved:
    st.session_state["PINECONE_API_KEY"] = pinecome_api_key
